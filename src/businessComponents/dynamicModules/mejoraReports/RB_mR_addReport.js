...
const RB_mR_addReport = () =>{
    ...
    return <div style={{textAlign:'left'}}>
        ...
        <div style={{margin:'8px auto 8px auto',display:'flex',border:'0px dashed red',width:'170px'}}>
            <div onClick={()=>changeMode('Standard')} className={mode==='Standard'?'titleButtonFirst_disabled':'titleButtonFirst'}>Standard</div>
            <div onClick={()=>changeMode('Advanced')} className={mode==='Advanced'?'titleButtonLast_disabled':'titleButtonLast'}>Advanced</div>
        </div>
        ...
        <pre style={{textAlign:'left'}}>
            {JSON.stringify(advQuery,2,2)}
        </pre>

        <div>advQueryFiltered</div>
        <pre style={{textAlign:'left'}}>
            {JSON.stringify(advQueryFiltered,2,2)}
        </pre>

        <div>finalResponse</div>
        <pre style={{textAlign:'left'}}>
            {JSON.stringify(finalResponse,2,2)}
        </pre>
