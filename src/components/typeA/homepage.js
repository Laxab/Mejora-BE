...
const Homepage = () =>{
    ...
    return <div className="" style={{display:'flex',alignItems:'center',margin:'auto',justifyContent:'center',flexDirection:'column'}}>
        ...
        <div className="logo"><div style={{display:'flex',margin:'auto 0px auto',letterSpacing:'-10px'}}><b>{state.businessNameShort}</b></div></div>
            <div className="footerContents" style={{textAlign:'center',fontFamily:'logo',fontSize:'55px',padding:'0px',margin:'10px 0px 0px'}}>{state.businessName}</div>
